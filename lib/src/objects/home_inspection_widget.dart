...
/// A kind of element
class HomeInspectionWidget extends StatelessWidget {
  final FlowElement element;

  const HomeInspectionWidget({
    Key? key,
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          CustomPaint(
            size: element.size,
            painter: _HomeInspectionPainter(
              element: element,
            ),
          ),
...
class _HomeInspectionPainter extends CustomPainter {
  final FlowElement element;

  _HomeInspectionPainter({
    required this.element,
  });

  @override
  void paint(Canvas canvas, Size size) {
    final icon = Icons.recent_actors_outlined;
