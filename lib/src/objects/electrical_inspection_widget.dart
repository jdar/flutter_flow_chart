...
/// A kind of element
class ElectricalInspectionWidget extends StatelessWidget {
  final FlowElement element;

  const ElectricalInspectionWidget({
    Key? key,
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          CustomPaint(
            size: element.size,
            painter: _ElectricInspectionPainter(
              element: element,
            ),
          ),
...
class _ElectricInspectionPainter extends CustomPainter {
  final FlowElement element;

  _ElectricInspectionPainter({
    required this.element,
  });

  @override
  void paint(Canvas canvas, Size size) {
    final icon = Icons.electric_bolt;
