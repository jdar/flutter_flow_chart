...
/// A kind of element
class OptionalPhotosWidget extends StatelessWidget {
  final FlowElement element;

  const OptionalPhotosWidget({
    Key? key,
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          CustomPaint(
            size: element.size,
            painter: _OptionalPhotosPainter(
              element: element,
            ),
          ),
...
class _OptionalPhotosPainter extends CustomPainter {
  final FlowElement element;

  _OptionalPhotosPainter({
    required this.element,
  });

  @override
  void paint(Canvas canvas, Size size) {
    final icon = Icons.add_a_photo;
