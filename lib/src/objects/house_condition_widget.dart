...
/// A kind of element
class HouseConditionWidget extends StatelessWidget {
  final FlowElement element;

  const HouseConditionWidget({
    Key? key,
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          CustomPaint(
            size: element.size,
            painter: _HouseConditionPainter(
              element: element,
            ),
          ),
...
class _HouseConditionPainter extends CustomPainter {
  final FlowElement element;

  _HouseConditionPainter({
    required this.element,
  });

  @override
  void paint(Canvas canvas, Size size) {
    final icon = Icons.handyman_outlined;
