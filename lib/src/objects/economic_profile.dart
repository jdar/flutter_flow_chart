...
/// A kind of element
class EconomicProfileWidget extends StatelessWidget {
  final FlowElement element;

  const EconomicProfileWidget({
    Key? key,
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          CustomPaint(
            size: element.size,
            painter: _EconomicProfilePainter(
              element: element,
            ),
          ),
...
class _EconomicProfilePainter extends CustomPainter {
  final FlowElement element;

  _EconomicProfilePainter({
    required this.element,
  });

  @override
  void paint(Canvas canvas, Size size) {
    final icon = Icons.attach_money;
