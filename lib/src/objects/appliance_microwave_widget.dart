...
/// A kind of element
class ApplianceMicrowaveWidget extends StatelessWidget {
  final FlowElement element;

  const ApplianceMicrowaveWidget({
    Key? key,
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          CustomPaint(
            size: element.size,
            painter: _ApplianceMicrowavePainter(
              element: element,
            ),
          ),
...
class _ApplianceMicrowavePainter extends CustomPainter {
  final FlowElement element;

  _ApplianceMicrowavePainter({
    required this.element,
  });

  @override
  void paint(Canvas canvas, Size size) {
    final icon = Icons.microwave;
