...
/// A kind of element
class ApplianceOtherWidget extends StatelessWidget {
  final FlowElement element;

  const ApplianceOtherWidget({
    Key? key,
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          CustomPaint(
            size: element.size,
            painter: _ApplianceOtherPainter(
              element: element,
            ),
          ),
...
class _ApplianceOtherPainter extends CustomPainter {
  final FlowElement element;

  _ApplianceOtherPainter({
    required this.element,
  });
