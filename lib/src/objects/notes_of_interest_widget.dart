...
/// A kind of element
class NotesOfInterestWidget extends StatelessWidget {
  final FlowElement element;

  const NotesOfInterestWidget({
    Key? key,
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          CustomPaint(
            size: element.size,
            painter: _NotesOfInterestPainter(
              element: element,
            ),
          ),
...
class _NotesOfInterestPainter extends CustomPainter {
  final FlowElement element;

  _NotesOfInterestPainter({
    required this.element,
  });
